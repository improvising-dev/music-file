...
export const MAJOR_CHORDS: readonly MFChord[] = [
  'I',
  'II',
  'III',
  'IV',
...
export const MAJOR_CHORD_SET = new Set<MFChord>(MAJOR_CHORDS)

export const MINOR_CHORDS: readonly MFChord[] = [
  'i',
  'ii',
  'iii',
  'iv',
...
export const MINOR_CHORD_SET = new Set<MFChord>(MINOR_CHORDS)
